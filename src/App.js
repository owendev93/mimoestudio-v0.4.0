  ...
  return (
    <Router>
      <div className="font-sans antialiased text-gray-900 bg-gradient-to-br from-purple-50 to-pink-50 min-h-screen">
        ...
        <nav className="flex justify-center gap-4 py-4 bg-purple-100">
          <Link to="/" className="hover:text-purple-700">Inicio</Link>
          <Link to="/galeria" className="hover:text-purple-700">Galería</Link>
          <Link to="/sobre-mi" className="hover:text-purple-700">Sobre mí</Link>
          <Link to="/contacto" className="hover:text-purple-700">Contacto</Link>
        </nav>
        ...
        <footer className="w-full pb-6 relative">
          ...
          <div className="flex flex-col md:flex-row justify-center md:justify-between items-center w-5/6 mx-auto gap-2 text-center md:text-left text-sm">
